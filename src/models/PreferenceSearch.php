...
/**
 * PreferenceSearch represents the model behind the search form about `yongtiger\user\models\Preference`.
 */
class PreferenceSearch extends Preference
{
    ...
    public function rules()
    {
        return [
            ...
            [['locale', 'time_offset', 'datetime_format', 'created_date_range', 'updated_date_range'], 'safe'],  ///[yii2-user:daterangepicker]
